#!/usr/bin/env bash
# Source this file: source switch-oageominfo.sh {local|original|status}
...
_nd280_switch_package oaGeomInfo OAGEOMINFO \
    "${_nd280_workspace}/SoftProj/oaGeomInfo" \
    "${_nd280_workspace}/ND280ppCont/usr/local/t2k/current/oaGeomInfo_6.9-plusplus" \
    "${1:-help}"
_switch_result=$?
